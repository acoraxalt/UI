local hexagame = Instance.new("ScreenGui")
local hexagame2 = Instance.new("Frame")
...
hexagame.Name = "hexagame"
hexagame.Parent = game.CoreGui
hexagame.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
mouse.KeyDown:connect(function(key) 
	key = key:lower() 
	if key == 'z' then -- 
		hexagame2.Visible = not hexagame2.Visible 
	end
end)

hexagame2.Name = "hexagame2"
hexagame2.Parent = hexagame
hexagame2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
hexagame2.BorderColor3 = Color3.fromRGB(27, 42, 53)
hexagame2.BorderSizePixel = 0
hexagame2.Position = UDim2.new(0.0517241396, 0, 0.30736196, 0)
hexagame2.Size = UDim2.new(0, 563, 0, 498)
hexagame2.Visible = true
hexagame2.Active = true
hexagame2.Draggable = true

UICorner.CornerRadius = UDim.new(0, 4)
UICorner.Parent = hexagame2
...
UIGradient.Parent = hexagame2

creditsframe.Name = "creditsframe"
creditsframe.Parent = hexagame2
...
gui.Name = "gui"
gui.Parent = scriptsframe
gui.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
gui.Position = UDim2.new(0.0314551368, 0, 0.136820883, 0)
gui.Size = UDim2.new(0, 335, 0, 36)
gui.Font = Enum.Font.GothamBlack
gui.Text = "GUI"
gui.TextColor3 = Color3.fromRGB(213, 213, 213)
gui.TextSize = 28.000
gui.TextWrapped = true
gui.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebinp.com/hJBbpbw6"))()
end)
...
UICorner_10.Parent = ezpets

yan.Name = "yan"
yan.Parent = hexagame2
...
universalframe.Parent = hexagame2
...
whiteui.MouseButton1Down:connect(function()
	hexagame:Destroy()
	wait(3)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/acoraxalt/UI/main/whitehexagame.lua"))()
end)
...
blackui.MouseButton1Down:connect(function()
	hexagame:Destroy()
	wait(3)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/acoraxalt/UI/main/blackhexagame.lua"))()
end)
