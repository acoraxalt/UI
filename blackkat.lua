local kat = Instance.new("ScreenGui")
local kat2 = Instance.new("Frame")
...
local realking = Instance.new("TextButton")
...
kat.Name = "kat"
kat.Parent = game.CoreGui
kat.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
mouse.KeyDown:connect(function(key) 
	key = key:lower() 
	if key == 'z' then -- 
		kat2.Visible = not kat2.Visible 
	end
end)

kat2.Name = "kat2"
kat2.Parent = kat
kat2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
kat2.BorderColor3 = Color3.fromRGB(27, 42, 53)
kat2.BorderSizePixel = 0
kat2.Position = UDim2.new(0.0517241396, 0, 0.30736196, 0)
kat2.Size = UDim2.new(0, 563, 0, 498)
kat2.Visible = true
kat2.Active = true
kat2.Draggable = true

UICorner.CornerRadius = UDim.new(0, 4)
UICorner.Parent = kat2
...
UIGradient.Parent = kat2

creditsframe.Name = "creditsframe"
creditsframe.Parent = kat2
...
realking.Name = "realking"
realking.Parent = scriptsframe
realking.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
realking.Position = UDim2.new(0.0258371588, 0, 0.225352108, 0)
realking.Size = UDim2.new(0, 335, 0, 36)
realking.Font = Enum.Font.GothamBlack
realking.Text = "Real King KAT GUI"
realking.TextColor3 = Color3.fromRGB(213, 213, 213)
realking.TextSize = 28.000
realking.TextWrapped = true
realking.MouseButton1Down:connect(function()
...
UICorner_7.Parent = realking

moonhub.Name = "moonhub"
moonhub.Parent = scriptsframe
moonhub.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
moonhub.Position = UDim2.new(0.0314551368, 0, 0.136820883, 0)
moonhub.Size = UDim2.new(0, 335, 0, 36)
moonhub.Font = Enum.Font.GothamBlack
moonhub.Text = "Moon Hub"
moonhub.TextColor3 = Color3.fromRGB(213, 213, 213)
moonhub.TextSize = 28.000
moonhub.TextWrapped = true
moonhub.MouseButton1Down:connect(function()
	pcall(function()
		local content = game:HttpGet("https://raw.githubusercontent.com/moonhubloader/system/main/authenticator.lua")
		loadstring(content)()
	end)
end)

UICorner_8.CornerRadius = UDim.new(0, 7)
UICorner_8.Parent = moonhub
...
whiteui.MouseButton1Down:connect(function()
	kat:Destroy()
	wait(3)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/acoraxalt/UI/main/whitekat.lua"))()
end)
...
blackui.MouseButton1Down:connect(function()
	kat:Destroy()
	wait(3)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/acoraxalt/UI/main/blackkat.lua"))()
end)
