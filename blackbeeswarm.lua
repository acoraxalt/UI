local beeswarm = Instance.new("ScreenGui")
local beeswarm2 = Instance.new("Frame")
...
local pepsiswarm = Instance.new("TextButton")
local UICorner_7 = Instance.new("UICorner")
local xlpgui = Instance.new("TextButton")
...
beeswarm.Parent = game.CoreGui
beeswarm.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
mouse.KeyDown:connect(function(key) 
	key = key:lower() 
	if key == 'z' then -- 
		beeswarm2.Visible = not beeswarm2.Visible 
	end
end)

beeswarm2.Name = "beeswarm2"
beeswarm2.Parent = beeswarm
beeswarm2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
beeswarm2.BorderColor3 = Color3.fromRGB(27, 42, 53)
beeswarm2.BorderSizePixel = 0
beeswarm2.Position = UDim2.new(0.0517241396, 0, 0.30736196, 0)
beeswarm2.Size = UDim2.new(0, 563, 0, 498)
beeswarm2.Visible = true
beeswarm2.Active = true
beeswarm2.Draggable = true

UICorner.CornerRadius = UDim.new(0, 4)
UICorner.Parent = beeswarm2
...
UIGradient.Parent = beeswarm2

creditsframe.Name = "creditsframe"
creditsframe.Parent = beeswarm2
...
gamename.Text = "Bee Swarm Simulator"
...
pepsiswarm.Parent = scriptsframe
pepsiswarm.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
pepsiswarm.Position = UDim2.new(0.0258371588, 0, 0.225352108, 0)
pepsiswarm.Size = UDim2.new(0, 335, 0, 36)
pepsiswarm.Font = Enum.Font.GothamBlack
pepsiswarm.Text = "Pepsi Swarm"
pepsiswarm.TextColor3 = Color3.fromRGB(213, 213, 213)
pepsiswarm.TextSize = 28.000
pepsiswarm.TextWrapped = true
pepsiswarm.MouseButton1Down:connect(function()
...
UICorner_7.Parent = pepsiswarm

xlpgui.Name = "xlpgui"
xlpgui.Parent = scriptsframe
xlpgui.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
xlpgui.Position = UDim2.new(0.0314551368, 0, 0.136820883, 0)
xlpgui.Size = UDim2.new(0, 335, 0, 36)
xlpgui.Font = Enum.Font.GothamBlack
xlpgui.Text = "Void Hub"
xlpgui.TextColor3 = Color3.fromRGB(213, 213, 213)
xlpgui.TextSize = 28.000
xlpgui.TextWrapped = true
xlpgui.MouseButton1Down:connect(function()
	_G.bsshook = "" -- variable for discord webhook, that can be used for functions in "Webhooking" tab. (NOT IMPORTANT)
...
UICorner_8.Parent = xlpgui

histyhub.Name = "histyhub"
histyhub.Parent = scriptsframe
histyhub.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
histyhub.Position = UDim2.new(0.0258371588, 0, 0.313883334, 0)
histyhub.Size = UDim2.new(0, 335, 0, 36)
histyhub.Font = Enum.Font.GothamBlack
histyhub.Text = "Floppa Hub"
histyhub.TextColor3 = Color3.fromRGB(213, 213, 213)
histyhub.TextSize = 28.000
histyhub.TextWrapped = true
histyhub.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Historia00012/HISTORIAHUB/main/BSS%20FREE"))()
end)

UICorner_9.CornerRadius = UDim.new(0, 7)
UICorner_9.Parent = histyhub

yan.Name = "yan"
yan.Parent = beeswarm2
...
universalframe.Parent = beeswarm2
...
whiteui.MouseButton1Down:connect(function()
	beeswarm:Destroy()
	wait(3)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/acoraxalt/UI/main/whitebeeswarm.lua"))()
end)
...
blackui.MouseButton1Down:connect(function()
	beeswarm:Destroy()
	wait(3)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/acoraxalt/UI/main/blackbeeswarm.lua"))()
end)
